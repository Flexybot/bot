...
-- Create indexes
create index on documents using btree (organization_id);
create index on documents using btree (chatbot_id);
create index on documents using gin (embedding vector_ops);
