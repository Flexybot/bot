...
BEGIN
  ...
  IF EXISTS (
    ...
    AND policyname = 'Users can read documents in their organization'
  ) THEN
    DROP POLICY "Users can read documents in their organization" ON documents;
  END IF;
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'documents' 
    AND policyname = 'Users can insert documents in their organization'
  ) THEN
    DROP POLICY "Users can insert documents in their organization" ON documents;
  END IF;
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'documents' 
    AND policyname = 'Users can update documents in their organization'
  ) THEN
    DROP POLICY "Users can update documents in their organization" ON documents;
  END IF;
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'documents' 
    AND policyname = 'Users can delete documents in their organization'
  ) THEN
    DROP POLICY "Users can delete documents in their organization" ON documents;
  END IF;
END $$;
